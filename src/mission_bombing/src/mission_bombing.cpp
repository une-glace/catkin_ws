...
serial::Serial serialPort(port, baudrate, serial::Timeout::simpleTimeout(1000));
	...
	pose1.pose.position.x = -7.8; pose1.pose.position.y =9.7; pose1.pose.position.z = 8;
	pose2.pose.position.x = 1.5; pose2.pose.position.y = 11.7; pose2.pose.position.z = 8;
	pose3.pose.position.x =15.5 ; pose3.pose.position.y = 15.9; pose3.pose.position.z = 8;
	...
	time_t timep3;
	while (ros::ok()){
	std::cout<<"waiting to enter mission "<<current_state.mode<<"\n";
